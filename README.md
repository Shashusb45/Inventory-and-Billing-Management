...
# Inventory Management and Billing Website 
...
```bash
  https://drive.google.com/file/d/1RGXfSzPwvFppVXQGHYGagseqewKVNGFU/view
```
...
```bash
  git clone https://github.com/Shashusb45/Inventory-and-Billing-Management.git
```
...
To run this project, you will need to add the following environment variables to your `.env` file (Create a file named `.env` at the root of your project directory, i.e., in **Inventory-and-Billing-Management** folder)
